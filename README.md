...
- 启动时输出统一固件版本号和关键功能标识，用于确认Arduino实际运行的烧录版本；
...
├─ firmware/px4/                  固件归档：供兼容的 FMUv6C 飞控手动刷写
├─ references/                    参考：STM32 桥接与 PX4 自定义模块源码
...
| [PX4 固件归档说明](firmware/px4/README.md) | FMUv6C 固件版本、用途与刷写注意事项 |
| [平台参考代码说明](references/README.md) | STM32 桥接与 PX4 自定义模块参考代码的适用范围 |
