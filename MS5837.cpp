...
#define MS5837_CONVERT_D1_8192    0x48
#define MS5837_CONVERT_D2_8192    0x58
// #define MS5837_CONVERT_D1_4096    0x42
// #define MS5837_CONVERT_D2_4096    0x52
#define DelayTime 10
...
int MS5837::check_step() const{
	return step;
}

void MS5837::read_nodelay() {
	if (millis() - last_MS_detect > DelayTime){
		if (step == 0){
...
void MS5837::read() {
	...
	delay(DelayTime); // Max conversion time per datasheet
